...
מאמין שטכנולוגיה צריכה לשרת את האדם, לא להפך.`,
  ...
  },
  {
    ...
    bio: "יזם וסמנכ\"ל תפעול לשעבר. מתמחה בפיתוח עסקי ויישום פתרונות AI. מרצה ומפתח תוכניות הכשרה באוניברסיטת חיפה ובטכניון.",
...
מרצה ומפתח תוכניות הכשרה באוניברסיטת חיפה ובטכניון, מחבר בין עולם העסקים לטכנולוגיה.`,
